...
export default function Apackages() {
      ...
      return (
        <div style={{background: '#0B0E13', width: "100vw", paddingBottom:'70px', zIndex:-1, direction:'rtl'}}>
          ...
          <div style={{background: '#0B0E13', width: "100vw", paddingBottom:'50px', zIndex:-1, height:'5vh'}}></div>
              ...
              {isDesktopOrLaptop && <motion.h2 initial={{ opacity: 0, scale: 0.5 }}
                  ...
                  transition={{
                    ...
                    delay: .5,
                    ease: [0, 0.71, 0.2, 1.01]}}
                    style={{marginRight:'4.5vh', marginLeft:'4.5vh', color:'white', fontSize:'2vh'}}
                ...
                <main >
                  <AnimatePresence mode='wait' >
                    <motion.div 
                      ...
                      style={{display:'flex'}}
                    >
                      <h1 style={{width:"20vw", fontSize:'20vh', marginTop:"10vh", marginLeft:"5vh", zIndex:0}}><Icon path={mdiProgressWrench} size={7}/> <br></br> <h1 style={{zIndex:1, color:selectedTab.col, textShadow:selectedTab.sha}}>25 omr</h1></h1>
